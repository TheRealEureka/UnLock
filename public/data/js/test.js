...
for(let key in obj) {
    document.getElementById("body").innerHTML += '<img src="../data/assets/cards/'+obj[key].image+'" />';
    if(obj[key].image_back !== null){
        document.getElementById("body").innerHTML += '<img src="../data/assets/cards/'+obj[key].image_back+'" />';
    }
}
